      ...
      <div className="flex flex-col items-center justify-center overflow-hidden">
        <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl ">
          ...
          <div className="flex mt-4 gap-x-2">
            <button
              type="button"
              className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1  focus:ring-pink-300"
            >
              <svg
            ...
            <button className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1  focus:ring-pink-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                className="w-5 h-5 fill-current"
          ...
          <p className="mt-8 text-xs font-light text-center text-gray-700">
            ...
            <a href="#" className="font-medium text-pink-300 hover:underline">
              Sign up
            </a>
          </p>
        </div>
